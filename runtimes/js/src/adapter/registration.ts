 ...
 * @throws {@link VivValidationError} If validation fails.
 */
 ...
 * @throws {@link VivValidationError} If any config parameter has an invalid value.
 */
 ...
 * @throws {@link VivValidationError} If any referenced enum is missing from the adapter.
 */
 ...
 * @throws {@link VivValidationError} If any referenced custom function is missing from the adapter.
 */
 ...
 * @throws {@link VivValidationError} If the adapter opts out of time-of-day modeling while the content
 *     bundle requires it.
 */
 ...
 * @throws {@link VivValidationError} If the content bundle includes entity-data assignments while the
 ...
 * @throws {@link VivValidationError} If any watched construct is not defined in the content bundle.
 */
