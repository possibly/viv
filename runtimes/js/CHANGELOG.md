...
* Optional `rng()` adapter function allowing the host application to expose a custom random number generator. This enables deterministic Viv execution given a constant seed.
